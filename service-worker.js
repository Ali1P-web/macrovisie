const CACHE='macrovisie-v10-1.0.0';
const ASSETS=['./','./index.html','./css/style.css','./js/app.js','./assets/logo.svg','./manifest.webmanifest','./data/dashboard.json','./data/sample.json'];
